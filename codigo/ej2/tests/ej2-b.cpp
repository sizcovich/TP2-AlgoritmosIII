...
int main() {
	/*
		ESTE .CPP HACE LA PARTE B DEL TP, LA QUE ES LINEAL, UNICAMENTE ENCONTRAR EL MASTER
	*/
	char termino = ' ';
	int cant_aristas = 0;
	int cant_nodos = 0;
	...
	while (termino != '0') {
		...
		vector<Arista> aristaLimpia = aristas;
		vector<vector<int> > listaDeAdyacenciaLimpia = listaDeAdyacencia;

		auto t1 = chrono::high_resolution_clock::now();		
		for (int i = 0; i < 20; ++i)
		{
			aristas = aristaLimpia;
			listaDeAdyacencia = listaDeAdyacenciaLimpia;
