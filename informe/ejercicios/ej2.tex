...
A continuación mostraremos un contraejemplo en el que denote la posibilidad de resolver las dos partes por separado de manera optima pero que aun así haya una solución en la que la replicación termine en menos tiempo. \newline
\newline
...
En términos generales, esto puede ocurrir para cualquier grafo en el que la solución del $ítem\ a$ (aplicar el algoritmo de $Kruskal$) no sea única, pudiendo ocasionar que varios subconjuntos del $ítem\ a$ tengan menor costo de replicación.\newline
...
\subsubsection{Pregunta 2}
 ...
 La principal diferencia entre uno y otro radica en que el primero ($broadcast$) con mandar una vez la información le alcanza, ya que cada servidor se guarda y enviá una copia, mientras que el segundo lo que hace es enviar una copia a cada nodo, por lo que realizar un envío de un nodo $a$ a un nodo $b$ cuesta la sumatoria del costo de cada arista del camino. \newline
